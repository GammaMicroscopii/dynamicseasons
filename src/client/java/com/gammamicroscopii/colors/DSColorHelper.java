...
public class DSColorHelper {
	...
	public static void registerBlockColors() {
		registerAutumnalLeavesColor(ModBlocks.DISCOLORED_BIRCH_LEAVES, ModBlocks.Items.DISCOLORED_BIRCH_LEAVES, 0xdcff78/*0x9f9503*/, DSColorHelper::getBirchColor, FoliageColors.getBirchColor());
		...
		registerSpringOrSummerLeavesColor(ModBlocks.LEAFING_OUT_BIRCH_BRANCHES, ModBlocks.Items.LEAFING_OUT_BIRCH_BRANCHES, DSColorHelper::getBirchColor, FoliageColors.getDefaultColor());
	...
	private static void registerAutumnalLeavesColor(Block blockForm, Item itemForm, int autumnalTextureColor, BiFunction<BlockRenderView, BlockPos, Integer> biomeTintedColorFunction, int defaultLeavesColor) {
		ColorProviderRegistry.BLOCK.register((state, world, pos, tintIndex) -> world != null && pos != null ? DSColorHelper.averageColors(autumnalTextureColor, biomeTintedColorFunction.apply(world, pos)) : DSColorHelper.averageColors(autumnalTextureColor, defaultLeavesColor), blockForm);
		ColorProviderRegistry.ITEM.register((stack, tintIndex) -> DSColorHelper.averageColors(autumnalTextureColor, defaultLeavesColor), itemForm);
